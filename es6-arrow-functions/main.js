...
const flash = {
  laughingUrl: 'images/flash-laugh.gif', // key-value pair
  laugh: function () { // laugh function
    setTimeout(
      () => {
        $flashImage.setAttribute('src', this.laughingUrl);
      // function with no parameter '()' being called to perform expression after '=>'
      }, 3000); // timer for laugh function
  }
};
